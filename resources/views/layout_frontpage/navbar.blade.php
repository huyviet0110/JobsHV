					...
					<ul class="dropdown-menu dropdown-with-icons">
						<li>
                            <a href="{{ route('language', 'vi') }}" class="dropdown-item notify-item">
                                ...
                                <span class="align-middle" style="margin-left: 10px">Vietnamese</span>
                            </a>
						</li>
						<li>
                            <a href="{{ route('language', 'en') }}" class="dropdown-item notify-item">
                                <img src="{{ asset('flags/us.svg') }}" alt="user-image" class="mr-1" height="12">
                                <span class="align-middle" style="margin-left: 10px">English</span>
                            </a>
						</li>
					</ul>
				</li>
